...
# Serialises read-modify-write cycles across threads (FastAPI request threads,
# smart_scheduler background thread). Note: protects THIS process only — the
# CLI and API server should not mutate tracker.csv concurrently from separate
# processes.
